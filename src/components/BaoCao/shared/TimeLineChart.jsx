...
const TimeLineChart = ({ data, loading }) => {
    ...
    const itemWidth = containerWidth > 0 ? containerWidth / MAX_VISIBLE_ITEMS : 80;

    // 🔥 TÍNH CHÍNH XÁC WIDTH BẰNG PIXEL THAY VÌ DÙNG '100%'
    const finalChartWidth = data.length > MAX_VISIBLE_ITEMS ? data.length * itemWidth : containerWidth;
            ...
            <div ref={wrapperRef} className="w-full overflow-x-auto overflow-y-hidden pb-2 custom-scrollbar">
                ...
                {loading ? (
                    ...
                    <div style={{ width: finalChartWidth, height: 260 }}>
                        <LineChart width={finalChartWidth} height={260} data={data} margin={{ top: 30, right: 30, left: 0, bottom: 5 }}>
