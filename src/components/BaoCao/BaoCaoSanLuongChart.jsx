...
const BaoCaoSanLuongChart = ({ startDate, endDate, dateType }) => {
    ...
    return (
        <div className="w-full bg-[#d9f2ff] p-6 rounded-2xl border border-blue-100 shadow-sm">
            <h2 className="text-xl font-bold text-gray-800 mb-6 px-2 tracking-tight">
                Sản lượng theo thời gian
            </h2>

            <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 relative min-h-[400px]">
                <h3 className="text-center text-gray-400 font-bold mb-8 text-[10px] uppercase tracking-widest">
                            ...
                            >
                                ...
                                <Bar dataKey="quantity" fill="#00a3e0" radius={[0, 4, 4, 0]} barSize={15}>
                                    <LabelList
                                        dataKey="quantity"
                                        position="right"
                                        style={{ fill: '#00a3e0', fontSize: 12, fontWeight: 'bold' }}
                                        offset={10}
                                    />
                                </Bar>
                            </BarChart>
