    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <Modal open={openExport} onClose={() => setOpenExport(false)}>
        <Box sx={{ ...modalStyle, maxWidth: 500 }}>
          <Typography variant="h6" component="h2" className="font-bold mb-2 text-blue-700 flex items-center gap-2">
                ...
                <Select
                  ...
                  renderValue={(selected) => {
                    if (selected.length === 0) {
                      return <span className="text-gray-500">-- Tất cả trạng thái --</span>;
                    }
                    return (
